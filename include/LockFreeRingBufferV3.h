...
#ifndef INCLUDE_LOCKFREERINGBUFFERV3_H_
#define INCLUDE_LOCKFREERINGBUFFERV3_H_
...
class LockFreeRingBufferV3 : public Queue<T> {
 public:
  ...
  virtual ~LockFreeRingBufferV3() { delete[] ring_; }
...
#endif  // INCLUDE_LOCKFREERINGBUFFERV3_H_
